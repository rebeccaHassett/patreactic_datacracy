...
def main():
    ...
    if args.state_number == 1:
        original_census_geo_file = '../original_data/census_block_geographical_data/Rhode_Island/census_blocks_geographical_ri.json'
        ...
        with open('../original_data/demographic_census_data/Rhode_Island/DEC_10_SF1_P11_with_ann.csv', newline='') as csvfile:
            ...
            data.pop(0)
            data.pop(0)
        with open("../original_data/census_block_geographical_data/Rhode_Island/census_blocks_geographical_ri.json") as f:
